...
{
    const String str{"TèstrtRÒNG"};
    EXPECT_NE(str.ToLower_Ascii7(), "tèststròng");
}
...
{
    const String str{"TèstStrìng"};
    EXPECT_NE(str.ToUpper_Ascii7(), "TÈSTSTRÒNG");
}
...
TEST(String_isHex, ValidHex)
{
    const String str{"0123456789abcdefABCDEF"};
    EXPECT_TRUE(str.isHex());
}

TEST(String_isHex, InvalidHex)
{
    const String str{"0123456789abcdefgABCDEFG"};
    EXPECT_FALSE(str.isHex());
}

TEST(String_isHex, EmptyString)
{
    const String str{""};
    EXPECT_TRUE(str.isHex());
}

TEST(String_isHex, NonHexCharacters)
{
    const String str{"TestString"};
    EXPECT_FALSE(str.isHex());
}

TEST(String_isHex, Whitespace)
{
    const String str{" 0123456789abcdefABCDEF "};
    EXPECT_FALSE(str.isHex());
}
